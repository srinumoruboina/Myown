...
public class DetailesPage 
{
	 ...
	 @FindBy(xpath="//div[@id='container']/div/div[3]/div[2]/div/div[2]/div[2]/div/div[3]/div")
	 private WebElement jerkinBtn2;
    ...
    public void clickonSizeBx(WebDriver driver)
	 ...
	 public void clickonjerkinBtn2(WebDriver driver)
	 {
		 WebDriverWait wait = new WebDriverWait(driver,10);
		 wait.until(ExpectedConditions.elementToBeClickable(jerkinBtn2));
		 jerkinBtn2.click();
	 }
}	 